...
public class ServletAdapter {
     ...
     * @throws Throwable
     */
    public void handleEvent(HttpServletRequest req, HttpServletResponse response, EventDispatcher eventDispatcher) throws Throwable {
        // 转换请求对象
     ...
     * @throws Throwable
     */
    public void handleCardAction(HttpServletRequest req, HttpServletResponse response, CardActionHandler handler) throws Throwable {
        // 转换请求对象
        EventReq eventReq = HTTP_TRANSLATOR.translate(req);
